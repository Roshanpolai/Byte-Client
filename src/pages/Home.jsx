...
//         <Container>
//           <div className="relative py-14 lg:py-16 max-w-2xl">
//             <span className="inline-block text-xs font-bold tracking-[0.2em] text-blue-200 uppercase mb-3">
...
//                   className="font-semibold px-5 py-2.5 hover:bg-blue-50 transition"
//                 >
//                   Explore Posts
//                 </Button>
//               </Link>
...
//                   className="font-semibold px-5 py-2.5 border border-white/40 hover:bg-white/10 transition"
//                 >
//                   Write a Post
//                 </Button>
//               </Link>
